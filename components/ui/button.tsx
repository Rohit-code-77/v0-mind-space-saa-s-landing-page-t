...
function buttonVariants(props?: { variant?: string; size?: string; className?: string }) {
  ...
  const variants: Record<string, string> = {
    default: "bg-primary text-primary-foreground hover:bg-primary/90 shadow-[inset_0px_0px_0px_1px_rgba(0,0,0,0.2)]",
    destructive:
  ...
  return cn(baseClasses, variants[variant], sizes[size], props?.className)
}
